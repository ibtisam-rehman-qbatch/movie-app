  ...
  return (
    <>
      <div className="bg-slate-400 ">
        <div className="relative w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow flex-col justify-center">
          <a href="#">
            <Suspense fallback={<div>Loading...</div>}>
              <PosterImg data={props.data} />
            </Suspense>
          </a>
          <div className=" border-green-600 border-4 w-3/4  items-center justify-center bg-white">
            <a href="#">
            ...
            <div className=" items-center justify-between flex ">
              ...
              {props.data?.myDate ? (
                <button
                  onClick={() =>
                    window.alert(
                      "You don't have any details of your own TV-Show"
                    )
                  }
